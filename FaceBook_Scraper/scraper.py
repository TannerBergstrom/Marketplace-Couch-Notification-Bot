...
def search():
    with sync_playwright() as p:
        ...
        page.goto("https://www.facebook.com/marketplace/105496622817769/search?maxPrice=300&daysSinceListed=1&query=couch&exact=false")
        ...
        listing_links = []
        for a_tag in soup.find_all('a', class_='x1i10hfl xjbqb8w x1ejq31n xd10rxx x1sy0etr x17r0tee x972fbf xcfux6l x1qhh985 xm0m39n x9f619 x1ypdohk xt0psk2 xe8uvvx xdj266r x11i5rnm xat24cr x1mh8g0r xexx8yu x4uap5 x18d9i69 xkhd6sd x16tdsg8 x1hl2dhg xggy1nq x1a2a7pz x1heor9g x1sur9pj xkrqix3 x1lku1pv', limit=25):  # Use the correct class name from the image
            href = a_tag.get('href')
...
def email(linksToSend):
    ...
    destination = ['kyleaburtt@gmail.com']
